					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="product-left-sidebar">
							...
							<div class="category-tag">
								...
								<a target="_blank" href="{{Asset('')}}tag/{{$convert->convertString($values->name)}}">{{$values->name}}</a>								
								@endforeach
							</div>
						</div>
											...
											<div class="list-view-content">
												<div class="single-product-item">
													...
													<div class="overlay-content-list">
														<ul id="{{$values->id}}">
														<li><a href="{{Asset('products')}}/{{$values->id}}/{{$convert->convertString($values->name)}}.html" title="Xem chi tiết"><i style="padding-top:10px" class="fa fa-search"></i></a></li>
														<li><a href="javascript:void(0)" title="Thêm vào giỏ hàng"><i style="padding-top:10px" class="fa fa-shopping-cart add-cart"></i></a></li>
														<!-- <li><a href="javascript:void(0)" title="So sánh"><i style="padding-top:10px" class="fa fa-retweet"></i></a></li> -->
														<li><a href="javascript:void(0)" title="Thêm vào yêu thích"><i style="padding-top:10px" class="fa fa-heart-o"></i></a></li>
													</ul>
													</div>												
												</div>														
											</div>
