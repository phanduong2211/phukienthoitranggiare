			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<!-- LOGO START -->
						<div class="logo">
							<a href="index.html"><img src="{{Asset('')}}public/img/logo.png" alt="bstore logo" /></a>
						</div>
						<!-- LOGO END -->
								...
								<div class="client-carousel">
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="{{Asset('')}}public/img/brand/1.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="{{Asset('')}}public/img/brand/2.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="{{Asset('')}}public/img/brand/3.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="{{Asset('')}}public/img/brand/4.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="{{Asset('')}}public/img/brand/5.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
