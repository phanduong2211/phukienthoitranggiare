...
<div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:5px">
       <div class="group-button clearfix">
           <a href="{{Asset('admin/news/add-category')}}" class="pull-left btn btn-primary btn-sm">Thêm mới</a>
       </div>
   </div>
            ...
            <td>
                {{$value->name}}
                 <div class="groupaction">
                        <a class="edit" href='{{Asset('admin/news/edit-category?id='.$value->id)}}'>Sửa</a>
                        <form method="post" action="{{Asset('admin/news/delete-category')}}" class="remove">
